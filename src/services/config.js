export default {
    keys: {
        ...
        tawk_to_widget_id: process.env.VUE_APP_TAWK_TO_WIDGET_ID || 'https://tawk.to/chat/63417cfd54f06e12d89916da/1gert0fs0',
        hotjar_site_id: process.env.VUE_APP_HOTJAR_SITE_ID || '3193020'
    },
